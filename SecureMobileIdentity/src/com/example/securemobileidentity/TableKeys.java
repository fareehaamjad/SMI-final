...
public class TableKeys 
{
	...
	private boolean exchangeKeysTrying;
	
	
	public TableKeys(String id, String ph_no, String pub_key, String date, String score, String Key_shouldUpdate, String b) throws ParseException
	{
	...
	public String getexchangeKeysTrying()
	{
	...
	public void updateexchangeKeysTrying(boolean b, DatabaseHandler db)
	{
		exchangeKeysTrying = b;
		
		db.updateTableKeys(this);
	}

	public boolean getexchangeKeysTrying_b() 
	{
		return exchangeKeysTrying;
	}
