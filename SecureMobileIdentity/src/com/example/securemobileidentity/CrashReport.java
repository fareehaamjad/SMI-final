...
public class CrashReport implements Thread.UncaughtExceptionHandler {
	...
	private String[] _recipients = new String[] { "mka325@nyu.edu" };
	private String _subject = "Crash Report CDC Android app";
	...
	private static CrashReport S_mInstance;
	...
	public void uncaughtException(Thread t, Throwable e) {
		...
		Report += "=============================";
		Report += "ERROR REPORT VOLLECTED ON : " + CurDate.toString();
		Report += "=============================";
		Report += "\n";
		Report += "\n";
		Report += "Informations :";
	...
	private void SendErrorMail(Context _context, String ErrorContent) {
		...
		_context.startActivity(Intent.createChooser(sendIntent, "Crash log: Choose an Email Client"));
	}
	...
	private void SaveAsFile(String ErrorContent) {
		try {
			...
			String logPath = Environment.getExternalStorageDirectory().getAbsolutePath() + Constants.LOGS_DIR + "crash.txt";;

			Constants.writeToNewLine(CurContext, logPath, ErrorContent);
		} catch (Exception e) {
			// ...
		}
	}
	...
	public static String currentVersionNumber(Context a) {
		...
		try {
			PackageInfo pi = pm.getPackageInfo(Constants.APP_PACKAGE,
